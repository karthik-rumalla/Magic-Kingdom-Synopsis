...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
    ...
    <%try{
     ...
     String sql1="select * from nowmovie";
 ...
 <tr>
       ...
       <%
        ...
        { %>
        	 ...
        	 <input type='hidden' name='mname' value='<%=rs.getString(2)%>'></input>
        	   <input type='hidden' name='tname' value='<%=rs.getString(1)%>'></input>
        	   <input type='hidden' name='aname' value='<%=rs.getString(8)%>'></input>
...
<th  align="left"><b><u>Movie : </u></b><label><%=rs.getString(1)%></label><br>

<b align="left"><u>Theater : </u></b><label><%=rs.getString(2)%></label><br>
...
<b align="left"><input type="submit" value="SEND ALERT"/><br>
