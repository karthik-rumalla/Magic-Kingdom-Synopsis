			...
			<div id="header">
				<div id="menu">
					<ul>
						...
						<li><a href="Theaters2.jsp" class="active">Theaters</a></li>
					</ul>
				</div>
...
<th align="left" colspan="2" ><img src="<%=rs.getString(8)%>" height="250" width="300"/></th><th></th><th></th>


<th  align="left"><b><u>Theater : </u></b><label><%=rs.getString(1)%></label><br>

<b align="left"><u>Area : </u></b><label><%=rs.getString(2)%></label><br>

<b align="left"><u>Address : </u></b><label><%=rs.getString(3)%></label><br>
<b align="left"><u>Phone : </u></b><label><%=rs.getString(4)%></label><br>
<b align="left"><u>Type : </u></b><label><%=rs.getString(5)%></label><br>
<b align="left"><u>No. of Screens : </u></b><label><%=rs.getString(6)%></label><br>
<b align="left"><u>Facilities available : </u></b><label><%=rs.getString(7)%></label><br><br>

</tr></table></center>
<center><table><tr>

<td align="center" colspan="2"/><%=rs.getString(9)%></tr>
					...
					<div id="footer_pad">
                        ...
                        <div class="foot_col2">
                            ...
                            <p>
								...
								E-mail:kathik.rumalla@gmail.com<br />
							</p>
                        </div>
                        <div><div></div></div>
                        <div class="foot_col4">
