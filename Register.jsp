	...
	<!-- .coda-slider -->
			...
			<div id="content">
				...
				<form action="RegisterServlet" method="post">
					<center>	<h2> Welcome to Registration Page</h2></center>	<br>
<center>
<table align='center'>
<tr>
<td></td>
...
<tr>
<td>Password</td>
<td><input title="at least eight symbols containing at least one number, one lower, and one upper letter" type="text" name="pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required />
</tr>
<tr>
...
<tr>
<td>Phone Number </td>
<td > <input type="text" name="phone" pattern="[7-9]{1}[0-9]{9}" title="Phone number with 7-9 and remaing 9 digit with 0-9">
</tr>
<tr>
<td>Email Id </td>
<td > <input type="text" title="email" name="email" required pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" /> 
</tr>
<tr>
<td>City</td>
<td><select name="city">
	...
	<option value="Ernaculum">Ernaculum</option>
...
<tr>
<td>Favourite Actor or Actress</td>
