...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
    ...
    <%try{
     ...
     String sql1="select distinct tname from theater";
	...
	<!-- .coda-slider -->
			...
			<div id="content">
				<div class="one_column">
					  <form  method="post" name="seat" action="AddMovieServlet">
					  <center>
<table>
<tr>
<td></td>
<td><font color='red'>${msg}</font></td>
 ...
 <tr><h2>Enter Details here to add a movie</h2>
								<tr>
...
%><tr>
								...
								<td align="left"><input type="text" name="mname" value="${sessionScope.mname}"/></td>
							  </tr><tr>
...
<tr>
                            <td align="left">Morning Show</td>
								<td align="left"><input type="text" name="moshow" value="${sessionScope.moshow}"/></td>
                        <td align="left">Matinee Show</td>
								<td align="left"><input type="text" name="mashow" value="${sessionScope.mashow}"/></td></tr>
                          <tr>     <td align="left">First Show</td>
								<td align="left"><input type="text" name="fshow" value="${sessionScope.fshow}"/></td>
                              <td align="left">Second Show</td>
								<td align="left"><input type="text" name="sshow" value="${sessionScope.sshow}"/></td></tr>
    ...
    <tr>
								...
								<td align="left"><input type="text" name="aname" value="${sessionScope.aname}"/></td>
							  </tr>
							  <tr>
								<td align="left">Director Name</td>
								<td align="left"><input type="text" name="dname" value="${sessionScope.dname}"/></td>
							  </tr>
							  <tr>
							 ...
							 <tr>
								...
								<td align="left"><input type="text" name="review" value="${sessionScope.review}"/></td>
							  </tr>	
							  <tr>
								<td align="left">Trailer</td>
								<td align="left"><input type="text" name="trailer" value="${sessionScope.trailer}"/></td>
							  </tr>	<br><br>
							  <tr>
								<td align="left">Photo</td>
								<td align="left"><input type="text" name="photo" value="${sessionScope.photo}"/></td>
							  </tr>	<br><br>
							  <tr>	  
							 	<td>&nbsp;</td>
