	...
	<!-- .coda-slider -->
			...
			<div id="content">
				<div class="one_column">
					 <center>	<h2>Update your details here</h2></center>	<br>
...
<td><select name="city">
	...
	<option value="3">Bhubaneshwar</option>
	<option value="4">Calcutta</option>
	<option value="5">Delhi</option>
	<option value="6">Ernaculum</option>
	<option value="7">Gauhati</option>
	<option value="8">Hyderabad</option>
	<option value="9">Indore</option>
	<option value="10">Jamshedpur</option>
	<option value="11">Kanpur</option>
	<option value="12">Ludhiana</option>
	<option value="13">Shillong</option>
