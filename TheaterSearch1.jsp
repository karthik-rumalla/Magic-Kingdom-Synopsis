...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
    ...
    <%try{
     ...
     String sql1="select * from theater where tname=?";
    ...
    <body>
		<div id="wrap">
			<div id="header">
				<div id="menu">
					<ul>
						<li><a href="AboutUs.jsp" class="active">Home</a></li>
...
<th align="center" colspan="2" ><img src="<%=rs1.getString(8)%>" height="300" width="300"/></th><th></th><th></th>
<th ><%=rs1.getString(9)%> </th><th></th><th></th>

<th  align="left"><b><u>Theater :    </u></b><label><%=rs1.getString(1)%></label><br>

<b align="left"><u>Area :   </u></b><label><%=rs1.getString(2)%></label><br>

<b align="left"><u>Address :    </u></b><label><%=rs1.getString(3)%></label><br>
<b align="left"><u>Phone :    </u></b><label><%=rs1.getString(4)%></label><br>
<b align="left"><u>Type :    </u></b><label><%=rs1.getString(5)%></label><br>
<b align="left"><u>No. of Screens :    </u></b><label><%=rs1.getString(6)%></label><br>
<b align="left"><u>Facilities available :    </u></b><label><%=rs1.getString(7)%></label><br><br></th></center>

</tr>
<tr>
<th></th></tr><br><br>
</table></center>
<center><h2>Movies showing in <%=rs1.getString(1)%></h2><br><br>
 	<%
        }        
        }catch(Exception e)
                {
	...
	<%try{
     String tname=request.getParameter("tname");
     String sql="select * from nowmovie where tname=?";
    Connection con=Dao.connect();
     System.out.println("Connected");
 ...
 <center>  <table  align="center" cellpadding="1"cellspacing="1">
 <tr>
...
<th align="left" colspan="2" ><img src="<%=rs.getString(13)%>" height="250" width="300"/></th><th></th><th></th>


<th  align="left"><b><u>Movie : </u></b><label><%=rs.getString(2)%></label><br>

<b align="left"><u>Screen : </u></b><label><%=rs.getString(3)%></label><br>

<b align="left"><u>Timings : </u></b><label><%=rs.getString(4)%></label><label><%=rs.getString(5)%></label><label><%=rs.getString(6)%></label><label><%=rs.getString(7)%></label><br>
<b align="left"><u>Actor Name : </u></b><label><%=rs.getString(8)%></label><br>
<b align="left"><u>Director Name : </u></b><label><%=rs.getString(9)%></label><br>
<b align="left"><u>Genre : </u></b><label><%=rs.getString(10)%></label><br>
<b align="left"><a href="<%=rs.getString(11)%>"/><u>View Review</u><br>

<b align="left"><a href="<%=rs.getString(12)%>"/><u>View Trailer</u><br>
