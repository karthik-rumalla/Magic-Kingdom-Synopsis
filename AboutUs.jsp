...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
	...
	$().ready(function() {
       $('#coda-slider-2').codaSlider({
           ...
           autoSlideStopW6henClicked: true	
			...
			<div id="header">
				<div id="menu">
					<ul>
						...
						<li><a href="Theaters2.jsp">Theaters</a></li>
					</ul>
				</div>
...
"Rangoon" is an epic love story, taking a beautiful film star from the film sets of 1944 Bollywood to the jungles of the India-Burma border where she must entertain the English and Indian troops. In the midst of battles and betrayals, Julia (Kangana Ranaut) falls in love with a young Indian soldier Nawab (Shahid Kapoor), and learns some bitter truths about the dream of Indian independence. Battle lines are drawn when her mentor and lover Rusi (Saif Ali Khan) learns of the torrid love affair. </div>
	...
	<tr>
	<td><img src="images/rohit.jpg"   height="150" width="150"/></td><td></td>
	<td><img src="images/nishanth.jpg"  height="150" width="150"/></td><td></td>
	<td><img src= "images/jyothi.jpg" height="150" width="150"/></td><td></td>
	<td><img src="images/priya.jpg" height="150" width="150"/></td><td></td></tr>
	
	<tr>
	<td><h2>Karthik Rumalla</h2><br>
	Head, Development<br>
	karthik.rumalla@gmail.com</td><td></td>
	
	<td><h2>Musthafa kaleem</h2><br>
	Head, Development<br>
	mdsaif507@gmail.com</td><td></td>
	
	<td><h2>Dobbala Akhil</h2><br>
	Head, Development<br>
	dobbalaakhil@gmail.com</td><td></td>
	
	<td><h2>Jangiti Priyanka</h2><br>
	Head, Development<br>
	jangiti.priyanka@gmail.com</td><td></td>
