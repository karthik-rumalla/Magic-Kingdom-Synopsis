			  ...
			  $("#B").click( function()
					{
						 alert("You have selected " +s+ " seats");
						 	...
						 	xmlhttp.send();
						 	document.getElementById("kk").value=y;
						    alert("after" +y);
...
<tr>
	...
	<input type="hidden" id="kk" name="q"/>
	<input type="text" size="10" name="numero" id="numero" value="0" />s
	<input type="submit" id="B" />
	</form>
	<!--  <center><a href="BookServ"><img id="B" src="submit-btn.png"></a></center>-->
</body>
</html>