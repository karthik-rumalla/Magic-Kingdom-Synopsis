	...
	<!-- .coda-slider -->
			...
			<div id="content">
				<div class="one_column">
					  <form  method="post" name="seat" action="AddTheaterServlet"><center>
<table>
<tr>
<td></td>
<td><font color='red'>${msg}</font></td>
</tr>
 <tr><h2>Enter details here to add theater</h2><br>
								<tr>
								<td align="left">Theater</td>
								
									<td align="left"><input type="text" name="tname" value="${sessionScope.tname}"/></td>
								</tr>
								<tr>
								<td align="left">Area</td>
								
									<td align="left"><input type="text" name="area" value="${sessionScope.area}"/></td>
								</tr>
								<tr>
								<td align="left">Address</td>
								
									<td align="left"><input type="text" name="address" value="${sessionScope.address}"/></td>
								</tr>
								<tr>
								<td align="left">Phone</td>
								
									<td align="left"><input type="text" name="phone" value="${sessionScope.phone}"/></td>
								</tr>
...
<tr>
                            <td align="left">No. of Screens</td>
								<td align="left"><input type="text" name="noofscreens" value="${sessionScope.noofscreens}"/></td>
                        <td align="left">Facilities</td>
								<td align="left"><input type="text" name="facilities" value="${sessionScope.facilities}"/></td>
              </tr><tr>         <td align="left">Photo</td>
								<td align="left"><input type="file" name="photo" value="${sessionScope.photo}"/></td>  </tr>   
								 <tr>
								<td align="left">Map</td>
								<td align="left">
									<input type="text" name="map" value="${sessionScope.map}"/>
								</td></tr>     
...
For any queries or problems, please leave a message we will get back to you as soon as we can </p>
			...
			<div id="footer">
				<p>Copyright  2017s. <!-- Do not remove -->MAGIC KINGDOM<!-- end --></p>
			</div>
		</div>
    </body>
</html>
