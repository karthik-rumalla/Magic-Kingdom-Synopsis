...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
   ...
   <%try{
     ...
     String sql1="select tname from nowmovie where mname=?";
     Connection con=Dao.connect();
     System.out.println("Connected....."+mname );
	...
	<!-- .coda-slider -->
			...
			<div id="content">
				<div class="one_column">
					  <form action="MovieBooking3.jsp" method="post">
      <center><table>
     <tr>
    
<td align="left">MOVIE</td>
<input type='hidden' name='mname' value="${uname}"/>
<td align="left"><label>${mname}</label></td>
      ...
      <tr>
       ...
       <%  while(rs1.next()){ %>
        ...
        <% } %></select></td>
         <td><input type="submit" value="BOOK A DATE"/></td>
            </tr>
        <%
