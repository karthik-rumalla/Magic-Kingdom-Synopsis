			...
			<div id="header">
				<div id="menu">
					<ul>
						...
						<li><a href="UserReg.jsp" class="active">User Details</a></li>
...
<style type="text/css">
  ...
  <%} %>
	...
	<tr>
	<td><img src="images/priya.jpg"  height="150" width="150"/></td><td></td>
	<td><img src="images/jyothi.jpg"  height="150" width="150"/></td><td></td>
	<td><img src="images/rohit.jpg"  height="150" width="150"/></td><td></td>
	<td><img src="images/nishanth.jpg" height="150" width="150"/></td><td></td></tr>
	
	<tr>
	<td><h2>Priynka Gooty</h2><br>
	Head, Development<br>
	priyanka@gmail.com</td><td></td>
	
	<td><h2>Jyothi kodag</h2><br>
	Head, Development<br>
	jyothi@gmail.com</td><td></td>
	
	<td><h2>Rohith</h2><br>
	Head, Development<br>
	rohith@gmail.com</td><td></td>
	
	<td><h2>Nishanth. L</h2><br>
	Head, Development<br>
	nishanth@gmail.com</td><td></td>
