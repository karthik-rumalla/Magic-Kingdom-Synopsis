...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
    ...
    String sql="select * from comingmovie";
	...
	<!-- .coda-slider -->
			...
			<div id="content">
				<div class="one_column">
					  <table height="10" width="1800" align="middle" border="1" cellpadding="1"cellspacing="1" >
<tr >
<th colspan="2" width="150">THEATER</th>
<th colspan="2" width="150">MOVIE </th>
<th colspan="2" width="150">ACTOR</th>
<th colspan="2" width="150">DIRECTOR</th>
<th colspan="2" width="150">GENRE</th>
<th colspan="2" width="150">REVIEW</th>
<th colspan="2" width="150">TRAILER</th>
</tr></table>
<table height="10" width="1800" align="middle" border="1" cellpadding="1"cellspacing="1">
<%
        while(rs.next())
...
<td colspan="2" width="150"><label><%=rs.getString(1)%></label></td>


<td colspan="2" width="150" ><label><%=rs.getString(2)%></label></td>


<td colspan="2" width="150"><label><%=rs.getString(3)%></label></td>

<td colspan="2" width="150"><label><%=rs.getString(4)%></label></td>


<td colspan="2" width="150"><label><%=rs.getString(5)%></label></td>

<td colspan="2" width="150"><a href="<%=rs.getString(6)%>"/><u>View Review</u></td>

<td colspan="2" width="150"><%=rs.getString(7)%></td>
