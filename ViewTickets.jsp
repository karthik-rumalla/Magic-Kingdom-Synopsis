...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
    ...
    try
    {
    	...
    	String uname=(String)session.getAttribute("uname");
	     ...
	     System.out.println("Connected"+session.getAttribute("uname"));
    ...
    <body>
		<div id="wrap">
			<div id="header">
				<div id="menu">
					<ul>
						<li><a href="Account.jsp" class="active">Home</a></li>
						<li><a href="MovieBooking.jsp">Tickets  </a></li>
						<li><a href="Creviews.jsp">Reviews</a></li>
...
"Rangoon" is an epic love story, taking a beautiful film star from the film sets of 1944 Bollywood to the jungles of the India-Burma border where she must entertain the English and Indian troops. In the midst of battles and betrayals, Julia (Kangana Ranaut) falls in love with a young Indian soldier Nawab (Shahid Kapoor), and learns some bitter truths about the dream of Indian independence. Battle lines are drawn when her mentor and lover Rusi (Saif Ali Khan) learns of the torrid love affair. </div>
	...
	<!-- .coda-slider -->
			...
			<center>		  <h2>Your Tickets</h2></center><br>
 <%
        while(rs2.next())
        {
        
        %>
   <input type='hidden' name='uname' value='<%=rs2.getString(1)%>'></input>
   <input type='hidden' name='mname' value='<%=rs2.getString(2)%>'></input>
   <input type='hidden' name='tname' value='<%=rs2.getString(3)%>'></input>
   <input type='hidden' name='date' value='<%=rs2.getString(4)%>'></input>
   <input type='hidden' name='time' value='<%=rs2.getString(5)%>'></input>
   <input type='hidden' name='seat' value='<%=rs2.getString(6)%>'></input>
   
<center>
<table cellpadding="1"cellspacing="1" border="1" width="400">

<tr><td align="left" id="uname"><u><b>USERNAME :        </b></u><label><%=rs2.getString(1) %></label></td></tr>
	
<tr><td align="left" id="uname"><u><b>MOVIE :           </b></u><label><%=rs2.getString(2) %></label></td></tr>
<tr><td align="left"><u><b>THEATER :          </b></u><label><%=rs2.getString(3) %></label></td></tr>
<tr><td align="left"><u><b>DATE :            </b></u><label><%=rs2.getString(4) %></label></td></tr>
<tr><td align="left"><u><b>TIME :             </b></u><label><%=rs2.getString(5) %></label></td></tr>
<tr><td align="left"><u><b>SEAT NOs :          </b></u><label><%=rs2.getString(6) %></label></td>
</tr>
</table>
<table>
 
<td><input type="submit" value="Cancel tickets"/>
</td></table>
