...
<!-- Initialize each slider on the page. Each slider must have a unique id -->
    ...
    String sql="select distinct aname from nowmovie";
	...
	<!-- .coda-slider -->
			...
			<div id="content">
				<div class="one_column">
					  <form action="ActorSearch1.jsp" method="post">
<center>
<table>
<tr>
<h2>Select an actor to search for their movies</h2><br>
       ...
       <%  while(rs.next()){ %>
        ...
        <% } %></select></td>
         <td><input type="submit" value="VIEW MOVIES"/></td>
            </tr>
        <%
...
For any queries or problems, please leave a message we will get back to you as soon as we can </p>
						...
						<form action="SendFeedbackServlet" method="post" enctype="text/plain">
                            	<fieldset>
                                	<input id="text2" type="text" name="uname" value="Your E-mail:" alt=""/><br />
                                	<textarea id="text_mess" name="feedback" cols="0" rows="0">Message:</textarea><br />
