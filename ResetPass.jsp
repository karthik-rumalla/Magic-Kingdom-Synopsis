...
<table align="center">
<center>	<h2> RESET PASSWORD HERE</h2></center>	<br>
<tr>
<td align="left" colspan="2">Current Password</td>
<td align="center"> <input type="password" name="pass"></td> 
</tr><tr>
<td align="left" colspan="2">New Password</td>
<td align="center"> <input type="password" name="npass"></td> 
</tr><tr>
<td align="left" colspan="2">Confirm Password</td>
<td align="center"> <input type="password" name="cnpass"></td> 
</tr>
<tr>

<td align="center"> <input type="hidden" name="userid" value="${loginid}"></td> 
</tr>
<tr>
<td colspan="2" >
